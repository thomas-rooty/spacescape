    ...
    >
      ...
      <Physics gravity={[0, -9.8, 0]}>
        ...
        <Debug scale={1} color="red">
          ...
          <Wall position={[0.3, 0, distanceFromEarth + 0.2]} rotation={[0, 0, 0]} args={[0.1, 0.4, 0.6]}/>
          <Wall position={[-0.3, 0, distanceFromEarth + 0.2]} rotation={[0, 0, 0]} args={[0.1, 0.4, 0.6]}/>
          <Wall position={[0, 0, distanceFromEarth + 0.5]} rotation={[0, Math.PI/-2, 0]} args={[0.1, 0.4, 0.6]}/>
          <Wall position={[0, 0, distanceFromEarth - 0.1]} rotation={[0, Math.PI/-2, 0]} args={[0.1, 0.4, 0.6]}/>
        </Debug>
      </Physics>
      <PointerLockControls/>
